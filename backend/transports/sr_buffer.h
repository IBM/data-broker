 ...
 */
#define dbBE_Transport_sr_buffer_processed( sr_buf ) ( (sr_buf)->_processed )
 ...
 */
static inline char* dbBE_Transport_sr_buffer_rewind_available_to( dbBE_Redis_sr_buffer_t *sr_buf,
                                                                  char *p )
{
  char *ret = p;
